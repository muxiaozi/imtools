...
int main(int argc, char** argv) {
    ...
    io.Fonts->AddFontFromFileTTF(u8"c:\\Windows\\Fonts\\Deng.ttf", 24.0f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
...
#endif
    {
        ...
        {
            ImGui::Begin("Android Logcat");

            static int item_current_2 = 0;
            ImGui::Combo("combo 2 (one-liner)", &item_current_2, "aaaa\0bbbb\0cccc\0dddd\0eeee\0\0");

            ImGuiWindowFlags window_flags = ImGuiWindowFlags_HorizontalScrollbar;
            ImGui::BeginChild("ChildL", ImVec2(0, 0), false, window_flags);
        ...
        if (show_another_window) {
            ImGui::Begin("Another Window",
                         &show_another_window);  // Pass a pointer to our bool variable
                                                 ...
                                                 // clicked)
            ImGui::Text("Hello from another window! %s", u8"🤣");
